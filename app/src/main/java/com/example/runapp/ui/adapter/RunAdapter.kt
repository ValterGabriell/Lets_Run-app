...
class RunAdapter(private val lista: List<RunModelFinal>) :
    ...
    private fun setViews(itemView: View, runModelFinal: RunModelFinal) {
        ...
        itemView.findViewById<TextView>(R.id.txtDay).text = runModelFinal.isDay
        itemView.findViewById<TextView>(R.id.txtCyti).text = runModelFinal.isCity
        ...
        if (runModelFinal.isCity == "Cidade") {
